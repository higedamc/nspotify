...
const ndk = new NDK({ signer: signer, explicitRelayUrls: ["wss://relay.yozora.world", "wss://relay.damus.io", "wss://relay.nostr.band", "wss://eden.nostr.land"]});
...
setInterval(async () => {
    try {
        ...
        const expiration = Math.floor((new Date().getTime() + ((60000*5)*5)) / 1000)
        songEv.tags = [
            ['d', 'music'],
